        ...
        <div class="row mt-3">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group d-flex">
                    ...
                    <input type="text" class="form-control form mx-2" id="address" style="width: 250px;" value="<?php echo "$STD_Address"; ?>">
        ...
        <div class="row">
            <div class="col-4">
                <div class="form-group d-flex">
                    ...
                    <input type="text" class="form-control form mx-2" id="subdistrict-id" style="width: 175px;" value="<?php echo "$SubDistrict_ID"; ?>">
                </div>
            </div>
        </div>
