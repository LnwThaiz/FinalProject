...
<body>
    ...
    <form method="post">
        ...
        <button type="submit" name="testCombo" id="testCombo" style="width: 100px;height: 50px">ส่ง</button>
    </form>
    ...
    if (isset($_POST['testCombo'])) {
        ...
        if (!empty($selected_subjects) && is_array($selected_subjects)) {
            foreach ($selected_subjects as $subject_id) {
                ...
                $sql = "INSERT INTO leave_detail (leave_id, subject_id) VALUES ('L008', '$subject_id')";
