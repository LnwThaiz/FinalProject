...
<body>
    ...
    <div style="width: 100%; height: 100%; position: relative; background: white">
        ...
        <div class="icon" style="left: 100px; top: 250px;">
            <img src="./img/Edituser-W.png" width="70">
        </div>
        <div class="icon" style="left: 189px; top: 280px;">
            <a href="User.php" class="text-white no-underline">ข้อมูลผู้ใช้</a>
        </div>
        <div style="width: 180px; height: 33px; left: 100px; top: 359px; position: absolute; ">
            <i class="fas fa-history"></i>
        </div>
        <div class="icon" style="left: 189px; top: 380px;">
            <a href="LeaveHistory.php" class="text-white no-underline">ประวัติการลา</a>
        </div>
        <div class="icon" style="left: 189px; top: 480px;">
            <a href="schedule.php" class="text-white no-underline">ตารางเรียน</a>
        </div>
        <div style="width: 180px; height: 33px; left: 100px; top: 450px; position: absolute; ">
            <i class="bi bi-calendar-fill icon-calendar"></i>
        </div>
        ...
        <!-- กล่องคอมเมนต์ -->
        <textarea style="left: 479px; top: 290px; resize: none; border-radius: 5px;
        ...
        font-size: 30px; font-family: 'Anakotmai',sans-serif; font-weight: 400; word-wrap: break-word">
            บันทึกการลา</div>
        <div class="file-input" style="left: 486px; top: 490px; width: auto;">
        ...
        <div>
            <select style="width: 159px; height: 50px; left: 1050px; top: 310px; position: absolute; background: white;
        ...
        <div>
            <select style="width: 159px; height: 50px; left: 1050px; top: 424px; position: absolute; background: white;
            border-radius: 15px;  font-size: 20px; font-family: 'Anakotmai',sans-serif; font-weight: 50;
        ...
        <div>
            <select style="width: 159px; height: 72px; left: 956px; top: 159px; position: absolute; background: white;
        ...
        <div>
            <select name="Type_of_eave" style="width: 159px; height: 72px; left: 1169px; top: 159px; position: absolute;
